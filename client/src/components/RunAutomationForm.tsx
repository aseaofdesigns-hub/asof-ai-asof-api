      ...
      <CardContent className="flex flex-col gap-4">
        ...
        {paidSessionId && (
          <div className="space-y-2">
            ...
            {/* Active tier badge — only before results; after results TierIncludes shows the tier */}
            {paidSessionTier && !result && (
              <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-white/5 border border-white/10">
                <span className="text-[10px] text-white/40 font-medium">Credit queued</span>
