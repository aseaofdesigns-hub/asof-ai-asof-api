        ...
        >
          <div>
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl">
              Paste any code — AI-written or your own — and get back: what was assumed, what could break, what to verify, and whether it's safe to ship.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <motion.div variants={item} className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="glass-card rounded-2xl p-6 border border-white/5 overflow-hidden flex flex-col min-h-[260px]">
                ...
                <div className="overflow-auto scrollbar-none max-h-[280px]">
